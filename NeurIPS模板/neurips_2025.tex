...
We study the sensitivity of DynaTree to confidence thresholds \((\tau_h,\tau_\ell)\) and branch bounds \((B_{\min},B_{\max})\) on WikiText-2 at \(T=1500\). The released sweep logs cover a coarse grid of representative configurations; Table~\ref{tab:appendix-sensitivity} reports these settings.
