...
We evaluate how throughput varies with generation length \(T\) on WikiText-2, comparing autoregressive decoding, a fixed tree configuration, and DynaTree. Table~\ref{tab:appendix-scalability} reports throughput and speedup for each \(T\).
