...
\begin{itemize}
  ...
  \item \textbf{Linear Speculative Decoding:} A linear-chain variant of speculative decoding where the draft model proposes a sequence of \(K\) tokens that are verified in parallel by the target model~\cite{spec_decode}.
