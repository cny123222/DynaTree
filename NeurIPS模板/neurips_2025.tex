...
\textbf{DynaTree} & \textbf{218.1\(\pm\)21.6} & \textbf{1.61\(\times\)} & \textbf{192.1\(\pm\)34.2} & \textbf{1.44\(\times\)} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{DynaTree} & 19.4\(\pm\)16.2 & \textbf{4.62\(\pm\)0.46} & 9.9\(\pm\)0.6 & \textbf{5.38\(\pm\)1.03} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{+ History Adaptation} & \textbf{218.1\(\pm\)21.6} & \textbf{1.61\(\times\)} & \textbf{+15.6\%} \\
\bottomrule
\end{tabular}
\end{table}

\paragraph{Additional analyses.}
We place supplementary sensitivity analyses (sequence-length scaling and parameter sensitivity) in Appendix~\ref{app:additional-analyses}.
...
We evaluate how throughput varies with generation length \(T\) on WikiText-2, comparing autoregressive decoding, linear speculative decoding, a fixed tree configuration, and DynaTree. Table~\ref{tab:appendix-scalability} reports throughput for each \(T\), along with the DynaTree speedup relative to autoregressive decoding.

\begin{table}[t]
\centering
\caption{\textbf{Sequence length scaling on WikiText-2.} Results are computed from the experiment logs released with this work. Throughput is in tokens/s (mean\(\pm\)std across prompts), and speedup is relative to AR at the same \(T\).}
\label{tab:appendix-scalability}
\small
\begin{tabular}{ccccccc}
\toprule
\(T\) & AR (t/s) & Linear (t/s) & Fixed Tree (t/s) & DynaTree (t/s) & Speedup & Accept. \\
\midrule
100  & 128.8\(\pm\)1.5 & 94.0\(\pm\)27.6 & 112.5\(\pm\)29.6 & 114.3\(\pm\)34.2 & 0.89\(\times\) & 40.3\% \\
200  & 131.5\(\pm\)1.1 & 119.4\(\pm\)26.4 & 140.1\(\pm\)28.0 & 143.0\(\pm\)34.6 & 1.09\(\times\) & 53.3\% \\
300  & 131.8\(\pm\)0.6 & 136.8\(\pm\)24.7 & 158.2\(\pm\)26.7 & 163.8\(\pm\)31.4 & 1.24\(\times\) & 65.6\% \\
500  & 127.2\(\pm\)10.0 & 152.3\(\pm\)23.1 & 177.9\(\pm\)21.9 & 188.2\(\pm\)32.4 & 1.48\(\times\) & 79.8\% \\
750  & 132.9\(\pm\)0.9 & 161.3\(\pm\)22.9 & 185.6\(\pm\)13.9 & 202.8\(\pm\)29.8 & 1.53\(\times\) & 88.7\% \\
1000 & 132.9\(\pm\)0.9 & 167.7\(\pm\)21.4 & 190.9\(\pm\)13.6 & 211.9\(\pm\)26.9 & 1.59\(\times\) & 94.7\% \\
1500 & 132.2\(\pm\)0.6 & 172.6\(\pm\)17.9 & 172.3\(\pm\)35.5 & 178.0\(\pm\)44.3 & 1.35\(\times\) & 102.2\% \\
\bottomrule
\end{tabular}
\end{table}
