...
We evaluate how throughput varies with generation length \(T\) on WikiText-2, comparing autoregressive decoding, linear speculative decoding, a fixed tree configuration, and DynaTree. Table~\ref{tab:length-scaling} reports throughput for each \(T\), along with the DynaTree speedup relative to autoregressive decoding. For \(T=1500\), we report the same measurements as in the main benchmark (Table~\ref{tab:main-results}) to ensure consistency.
...
\toprule
\(T\) & AR (t/s) & Linear (t/s) & Fixed Tree (t/s) & DynaTree (t/s) & Speedup \\
\midrule
100  & \textbf{128.8\(\pm\)1.5} & 94.0\(\pm\)27.6 & 112.5\(\pm\)29.6 & 114.3\(\pm\)34.2 & 0.89\(\times\) \\
200  & 131.5\(\pm\)1.1 & 119.4\(\pm\)26.4 & 140.1\(\pm\)28.0 & \textbf{143.0\(\pm\)34.6} & 1.09\(\times\) \\
300  & 131.8\(\pm\)0.6 & 136.8\(\pm\)24.7 & 158.2\(\pm\)26.7 & \textbf{163.8\(\pm\)31.4} & 1.24\(\times\) \\
500  & 127.2\(\pm\)10.0 & 152.3\(\pm\)23.1 & 177.9\(\pm\)21.9 & \textbf{188.2\(\pm\)32.4} & 1.48\(\times\) \\
750  & 132.9\(\pm\)0.9 & 161.3\(\pm\)22.9 & 185.6\(\pm\)13.9 & \textbf{202.8\(\pm\)29.8} & 1.53\(\times\) \\
1000 & 132.9\(\pm\)0.9 & 167.7\(\pm\)21.4 & 190.9\(\pm\)13.6 & \textbf{211.9\(\pm\)26.9} & 1.59\(\times\) \\
1500 & 135.2\(\pm\)0.6 & 163.2\(\pm\)26.0 & 188.6\(\pm\)16.7 & \textbf{218.1\(\pm\)21.6} & 1.61\(\times\) \\
\bottomrule
\end{tabular}
\end{table}
