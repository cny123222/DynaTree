...
\begin{table}[t]
\centering
\caption{\textbf{Progressive component breakdown on WikiText-2 (\(T=1500\)).} Throughput (tokens/s) and speedup are computed relative to the autoregressive baseline under the same setting. \(\Delta\) vs.\ Fixed is computed relative to the fixed-tree backbone in this ablation run.}
