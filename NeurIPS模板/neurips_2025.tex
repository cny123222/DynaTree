...
\begin{itemize}
  ...
  \item We introduce a lightweight three-component adaptation mechanism (dynamic breadth, dynamic depth, and history adaptation) that integrates with tree-attention verification and probability-threshold pruning.
