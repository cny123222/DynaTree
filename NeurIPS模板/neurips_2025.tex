...
\midrule
100  & 83.3\(\pm\)27.7 & 94.3\(\pm\)27.7 & 103.5\(\pm\)39.2 & \textbf{116.6\(\pm\)35.6} & 1.40\(\times\) \\
200  & 110.1\(\pm\)27.8 & 117.7\(\pm\)26.4 & 139.4\(\pm\)28.3 & \textbf{142.0\(\pm\)34.6} & 1.29\(\times\) \\
300  & 131.9\(\pm\)0.7 & 134.6\(\pm\)25.3 & \textbf{158.3\(\pm\)27.2} & 144.7\(\pm\)48.7 & 1.10\(\times\) \\
500  & 123.9\(\pm\)18.0 & 148.0\(\pm\)23.4 & 158.1\(\pm\)37.4 & \textbf{185.8\(\pm\)32.0} & 1.50\(\times\) \\
1000 & 136.5\(\pm\)0.6 & 166.4\(\pm\)22.6 & 192.4\(\pm\)13.0 & \textbf{215.4\(\pm\)26.5} & 1.58\(\times\) \\
1200 & 128.8\(\pm\)12.4 & 168.3\(\pm\)20.9 & 169.2\(\pm\)31.5 & \textbf{218.4\(\pm\)24.8} & 1.70\(\times\) \\
1500 & 132.8\(\pm\)0.7 & 169.1\(\pm\)19.1 & 188.0\(\pm\)16.5 & \textbf{218.5\(\pm\)22.2} & 1.65\(\times\) \\
1800 & 133.2\(\pm\)0.8 & 160.8\(\pm\)28.2 & 188.0\(\pm\)17.8 & \textbf{219.1\(\pm\)21.0} & 1.64\(\times\) \\
\bottomrule
\end{tabular}
\end{table}
