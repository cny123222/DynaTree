...
\begin{figure}[t]
  ...
  \caption{\textbf{Ablation progression on WikiText-2 (\(T=1500\)).} Adding Dynamic Breadth \& Depth increases throughput and reduces the number of verification iterations; History Adaptation further improves throughput and reduces iterations by committing longer prefixes per step.}
